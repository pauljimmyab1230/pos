    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-semibold text-gray-900 dark:text-white">Caja Registradora</h1>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-12 text-gray-500 dark:text-gray-400">
          ...
          <p className="text-sm text-gray-400 dark:text-gray-500">
            {search ? 'No se encontraron resultados' : 'Registra tu primer movimiento'}
          </p>
        </div>
      ) : (
        <div className="space-y-2">
          {filteredMovements.map((movement) => (
            ...
            >
              ...
              >
                {movement.tipo === 'INGRESO' ? (
                  <ArrowUpRight className="w-6 h-6 text-green-500 dark:text-green-400" />
                ) : (
                  <ArrowDownRight className="w-6 h-6 text-red-500 dark:text-red-400" />
                )}
              </div>
              <div className="flex-1 min-w-0">
                <p className="font-medium text-gray-900 dark:text-white truncate">{movement.concepto}</p>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-end sm:items-center justify-center">
          <div className="bg-white dark:bg-gray-800 rounded-t-2xl sm:rounded-2xl w-full max-w-md">
            <div className="p-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
              <h3 className="font-semibold text-lg text-gray-900 dark:text-white">Nuevo Movimiento</h3>
              <button
            ...
            <form onSubmit={handleSubmit} className="p-4 space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                  Concepto <span className="text-red-500 dark:text-red-400">*</span>
                </label>
                <input
                  type="text"
                  value={form.concepto}
